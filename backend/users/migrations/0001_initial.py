    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.TextField(max_length=150, unique=True, verbose_name='Пользователь')),
                ('role', models.CharField(choices=[('user', 'user'), ('admin', 'admin')], default='user', max_length=10, verbose_name='Роль')),
